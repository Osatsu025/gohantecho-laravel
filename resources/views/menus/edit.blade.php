          ...
          <div class="max-w-xl mx-auto">
            <form method="POST" action="{{ route('menus.update', $menu) }}">
              ...
              <fieldset class="fieldset bg-base-200 border-base-300 rounded-box w-l border p-4">
                ...
                <input type="text" class="input input-xs" id="tag_input" name="input_tags" value="{{ old('$menu->formatted_tags') ?? $input_selected_tags }}" placeholder="下から選択するか、半角スペースで区切って入力">
                <div id="tag_div">
                  @foreach ($tags as $tag)
                    <input
                      type="checkbox"
